...
class Constants
{
  //DATABASE DETAILS
   ...
   /*  static $DB_SERVER="localhost";
	...
	static $SQL_SELECT_ALL_VIEW ="SELECT * FROM reg_02_08_21_vw  ORDER BY id_vw";
	
	static $SQL_SELECT_ALL_2 ="SELECT * FROM reg_cuatm_11_20  ORDER BY id_cu";
	
	static $SQL_SELECT_ALL_3 ="SELECT * FROM reg_caem_11_20  ORDER BY id";
	
	static $SQL_SELECT_ALL_4 ="SELECT * FROM reg_cfp_11_20  ORDER BY id";
