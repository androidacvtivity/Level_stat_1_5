...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dir_pret;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dir_pret extends RecyclerView.Adapter<MyAdapter_dir_pret.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dir_pret.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dir_pret.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dir_pret(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dir_pret.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dir_pret.ViewHolder vh = new MyAdapter_dir_pret.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dir_pret.ViewHolder holder, int position) {
