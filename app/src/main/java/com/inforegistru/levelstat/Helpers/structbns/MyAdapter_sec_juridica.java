...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_sec_juridica;
import com.github.ivbaranov.mli.MaterialLetterIcon;


public class MyAdapter_sec_juridica extends RecyclerView.Adapter<MyAdapter_sec_juridica.ViewHolder>{
    private Context c;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_sec_juridica.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_sec_juridica.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_sec_juridica(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_sec_juridica.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_sec_juridica.ViewHolder vh = new MyAdapter_sec_juridica.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_sec_juridica.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_sec_juridica.class));
    }
    @Override
