...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_crs_sd_basarabeasca;
import com.github.ivbaranov.mli.MaterialLetterIcon;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;
public class MyAdapter_crs_sud_basarabeasca  extends RecyclerView.Adapter<MyAdapter_crs_sud_basarabeasca.ViewHolder>{
    private Context c;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_crs_sud_basarabeasca.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_crs_sud_basarabeasca.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_crs_sud_basarabeasca(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_crs_sud_basarabeasca.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_crs_sud_basarabeasca.ViewHolder vh = new MyAdapter_crs_sud_basarabeasca.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_crs_sud_basarabeasca.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_crs_sd_basarabeasca.class));
    }
