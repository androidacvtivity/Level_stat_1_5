...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_ser_sistem_geografic;

import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_ser_sistem_informatic extends RecyclerView.Adapter<MyAdapter_ser_sistem_informatic.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_ser_sistem_informatic.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_ser_sistem_informatic.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_ser_sistem_informatic(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_ser_sistem_informatic.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_ser_sistem_informatic.ViewHolder vh = new MyAdapter_ser_sistem_informatic.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_ser_sistem_informatic.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_ser_sistem_geografic.class));
    }
    @Override
