...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dg_it;

import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dg_it extends RecyclerView.Adapter<MyAdapter_dg_it.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dg_it.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dg_it.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dg_it(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dg_it.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dg_it.ViewHolder vh = new MyAdapter_dg_it.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dg_it.ViewHolder holder, int position) {
