...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dr_nivel_trai;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dr_nivel_trai extends RecyclerView.Adapter<MyAdapter_dr_nivel_trai.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dr_nivel_trai.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dr_nivel_trai.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dr_nivel_trai(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dr_nivel_trai.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dr_nivel_trai.ViewHolder vh = new MyAdapter_dr_nivel_trai.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dr_nivel_trai.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dr_nivel_trai.class));
    }
    @Override
