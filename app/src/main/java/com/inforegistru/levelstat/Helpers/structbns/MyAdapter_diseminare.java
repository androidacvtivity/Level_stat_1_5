...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dr_diseminare;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_diseminare extends RecyclerView.Adapter<MyAdapter_diseminare.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_diseminare.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_diseminare.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_diseminare(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_diseminare.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_diseminare.ViewHolder vh = new MyAdapter_diseminare.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_diseminare.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dr_diseminare.class));
    }
    @Override
