...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_sec_stat_med;
import com.github.ivbaranov.mli.MaterialLetterIcon;



public class MyAdapter_sec_stat_med extends RecyclerView.Adapter<MyAdapter_sec_stat_med.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_sec_stat_med.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_sec_stat_med.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_sec_stat_med(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_sec_stat_med.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_sec_stat_med.ViewHolder vh = new MyAdapter_sec_stat_med.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_sec_stat_med.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_sec_stat_med.class));
    }
    @Override
