...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dg_colect_data;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dg_colect_data extends RecyclerView.Adapter<MyAdapter_dg_colect_data.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dg_colect_data.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dg_colect_data.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dg_colect_data(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dg_colect_data.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dg_colect_data.ViewHolder vh = new MyAdapter_dg_colect_data.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dg_colect_data.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dg_colect_data.class));
    }
    @Override
