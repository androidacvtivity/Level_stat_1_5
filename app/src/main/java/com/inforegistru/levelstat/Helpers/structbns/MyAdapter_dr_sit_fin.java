...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dr_sit_fin;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dr_sit_fin extends RecyclerView.Adapter<MyAdapter_dr_sit_fin.ViewHolder>{
...
public class ViewHolder extends RecyclerView.ViewHolder implements
    ...
    private MyAdapter_dr_sit_fin.ItemClickListener itemClickListener;
    /**
    ...
    public void setItemClickListener(MyAdapter_dr_sit_fin.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dr_sit_fin(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dr_sit_fin.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dr_sit_fin.ViewHolder vh = new MyAdapter_dr_sit_fin.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dr_sit_fin.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dr_sit_fin.class));
    }
    @Override
