...
import com.inforegistru.levelstat.Views.DetailActivitystr;
...
public class MyAdapterstr extends RecyclerView.Adapter<MyAdapterstr.ViewHolder>{
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapterstr.ViewHolder holder, int position) {
