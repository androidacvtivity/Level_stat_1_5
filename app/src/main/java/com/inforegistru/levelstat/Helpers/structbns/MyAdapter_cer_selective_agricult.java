...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_cer_selective_agricult;
import com.github.ivbaranov.mli.MaterialLetterIcon;



public class MyAdapter_cer_selective_agricult extends RecyclerView.Adapter<MyAdapter_cer_selective_agricult.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_cer_selective_agricult.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_cer_selective_agricult.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_cer_selective_agricult(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_cer_selective_agricult.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_cer_selective_agricult.ViewHolder vh = new MyAdapter_cer_selective_agricult.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_cer_selective_agricult.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_cer_selective_agricult.class));
    }
    @Override
