...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_chisinau;

import com.github.ivbaranov.mli.MaterialLetterIcon;


public class MyAdapter_mun_chisinau extends RecyclerView.Adapter<MyAdapter_mun_chisinau.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chisinau.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chisinau.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chisinau(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chisinau.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chisinau.ViewHolder vh = new MyAdapter_mun_chisinau.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chisinau.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_chisinau.class));
    }
    @Override
