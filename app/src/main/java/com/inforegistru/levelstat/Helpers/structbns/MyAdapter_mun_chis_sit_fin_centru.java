...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_sit_fin_centru;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_mun_chis_sit_fin_centru extends RecyclerView.Adapter<MyAdapter_mun_chis_sit_fin_centru.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_sit_fin_centru.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_sit_fin_centru.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_sit_fin_centru(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_sit_fin_centru.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_sit_fin_centru.ViewHolder vh = new MyAdapter_mun_chis_sit_fin_centru.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_sit_fin_centru.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_sit_fin_centru.class));
    }
    @Override
