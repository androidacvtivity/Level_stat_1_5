...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dr_app;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dr_app extends RecyclerView.Adapter<MyAdapter_dr_app.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dr_app.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dr_app.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dr_app(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dr_app.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dr_app.ViewHolder vh = new MyAdapter_dr_app.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dr_app.ViewHolder holder, int position) {
