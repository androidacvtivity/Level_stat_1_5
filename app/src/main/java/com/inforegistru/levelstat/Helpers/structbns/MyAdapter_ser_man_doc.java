...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_ser_men_doc;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_ser_man_doc extends RecyclerView.Adapter<MyAdapter_ser_man_doc.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_ser_man_doc.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_ser_man_doc.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_ser_man_doc(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_ser_man_doc.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_ser_man_doc.ViewHolder vh = new MyAdapter_ser_man_doc.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_ser_man_doc.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_ser_men_doc.class));
    }
    @Override
