...
import com.inforegistru.levelstat.Views.DetailActivity;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String name = s.getName().toLowerCase(Locale.getDefault()).trim();
        String galaxy = s.getGalaxy().toLowerCase(Locale.getDefault()).trim();
        String star = s.getStar().toLowerCase(Locale.getDefault()).trim();
        String depart = s.getDepart().toLowerCase(Locale.getDefault()).trim();
        String sectia = s.getSectia().toLowerCase(Locale.getDefault()).trim();
        String serviciu = s.getServiciu().toLowerCase(Locale.getDefault()).trim();
        String phone = s.getPhone().toLowerCase(Locale.getDefault()).trim();
        String description = s.getDescription().toLowerCase(Locale.getDefault()).trim();
        String formname = s.getFormname().toLowerCase(Locale.getDefault()).trim();
        String phonemobile = s.getPhonemobil().toLowerCase(Locale.getDefault()).trim();
