...
import com.inforegistru.levelstat.Views.DetailActivitystr2;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapterstr2 extends RecyclerView.Adapter<MyAdapterstr2.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapterstr2.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapterstr2.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapterstr2(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapterstr2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapterstr2.ViewHolder vh = new MyAdapterstr2.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapterstr2.ViewHolder holder, int position) {
