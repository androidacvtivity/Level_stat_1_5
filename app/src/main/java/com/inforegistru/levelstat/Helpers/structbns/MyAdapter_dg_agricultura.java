...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dg_agricultura;

import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dg_agricultura extends RecyclerView.Adapter<MyAdapter_dg_agricultura.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dg_agricultura.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dg_agricultura.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dg_agricultura(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dg_agricultura.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dg_agricultura.ViewHolder vh = new MyAdapter_dg_agricultura.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dg_agricultura.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dg_agricultura.class));
    }
    @Override
