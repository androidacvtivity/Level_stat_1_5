...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_cer_gospodarii;

import com.github.ivbaranov.mli.MaterialLetterIcon;
public class MyAdapter_mun_chis_cer_gospodarii extends RecyclerView.Adapter<MyAdapter_mun_chis_cer_gospodarii.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_cer_gospodarii.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_cer_gospodarii.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_cer_gospodarii(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_cer_gospodarii.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_cer_gospodarii.ViewHolder vh = new MyAdapter_mun_chis_cer_gospodarii.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_cer_gospodarii.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_cer_gospodarii.class));
    }
