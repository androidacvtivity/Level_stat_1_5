...
import com.inforegistru.levelstat.Views.DetailActivitydirectia_internationala;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dir_intern extends RecyclerView.Adapter<MyAdapter_dir_intern.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dir_intern.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dir_intern.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dir_intern(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dir_intern.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dir_intern.ViewHolder vh = new MyAdapter_dir_intern.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dir_intern.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivitydirectia_internationala.class));
    }
    @Override
