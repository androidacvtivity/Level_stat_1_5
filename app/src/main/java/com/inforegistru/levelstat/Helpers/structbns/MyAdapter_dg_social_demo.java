...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dg_social_demo;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_dg_social_demo extends RecyclerView.Adapter<MyAdapter_dg_social_demo.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dg_social_demo.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dg_social_demo.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dg_social_demo(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dg_social_demo.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dg_social_demo.ViewHolder vh = new MyAdapter_dg_social_demo.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dg_social_demo.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dg_social_demo.class));
    }
    @Override
