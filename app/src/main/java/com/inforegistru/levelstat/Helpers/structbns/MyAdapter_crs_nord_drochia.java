...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_crs_nord_drochia;
import com.github.ivbaranov.mli.MaterialLetterIcon;
public class MyAdapter_crs_nord_drochia extends RecyclerView.Adapter<MyAdapter_crs_nord_drochia.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_crs_nord_drochia.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_crs_nord_drochia.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_crs_nord_drochia(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_crs_nord_drochia.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_crs_nord_drochia.ViewHolder vh = new MyAdapter_crs_nord_drochia.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_crs_nord_drochia.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_crs_nord_drochia.class));
    }
