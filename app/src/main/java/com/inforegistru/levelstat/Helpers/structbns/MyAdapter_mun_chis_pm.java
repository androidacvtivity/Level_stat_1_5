...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_chi_pm;
import com.github.ivbaranov.mli.MaterialLetterIcon;


public class MyAdapter_mun_chis_pm extends RecyclerView.Adapter<MyAdapter_mun_chis_pm.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_pm.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_pm.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_pm(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_pm.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_pm.ViewHolder vh = new MyAdapter_mun_chis_pm.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_pm.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_chi_pm.class));
    }
    @Override
