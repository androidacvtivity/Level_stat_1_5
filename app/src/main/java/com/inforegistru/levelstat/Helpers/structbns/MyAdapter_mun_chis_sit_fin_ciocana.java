...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_sit_fin_ciocana;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_mun_chis_sit_fin_ciocana extends RecyclerView.Adapter<MyAdapter_mun_chis_sit_fin_ciocana.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_sit_fin_ciocana.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_sit_fin_ciocana.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_sit_fin_ciocana(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_sit_fin_ciocana.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_sit_fin_ciocana.ViewHolder vh = new MyAdapter_mun_chis_sit_fin_ciocana.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_sit_fin_ciocana.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_sit_fin_ciocana.class));
    }
    @Override
