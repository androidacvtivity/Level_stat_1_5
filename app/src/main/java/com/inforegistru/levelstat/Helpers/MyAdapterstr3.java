...
import com.inforegistru.levelstat.Views.DetailActivitystr3;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapterstr3  extends RecyclerView.Adapter<MyAdapterstr3.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapterstr3.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapterstr3.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapterstr3(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapterstr3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapterstr3.ViewHolder vh = new MyAdapterstr3.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapterstr3.ViewHolder holder, int position) {
