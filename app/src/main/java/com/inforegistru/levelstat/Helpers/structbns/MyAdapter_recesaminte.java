...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_recesaminte;

import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_recesaminte extends RecyclerView.Adapter<MyAdapter_recesaminte.ViewHolder> {
    private Context c;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_recesaminte.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_recesaminte.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_recesaminte(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_recesaminte.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_recesaminte.ViewHolder vh = new MyAdapter_recesaminte.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_recesaminte.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_recesaminte.class));
    }
    @Override
