...
import com.inforegistru.levelstat.Views.DetailActivity_sec_audit;
import com.github.ivbaranov.mli.MaterialLetterIcon;


public class MyAdapter_sec_audit extends RecyclerView.Adapter<MyAdapter_sec_audit.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_sec_audit.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_sec_audit.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_sec_audit(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_sec_audit.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_sec_audit.ViewHolder vh = new MyAdapter_sec_audit.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_sec_audit.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_sec_audit.class));
    }
    @Override
