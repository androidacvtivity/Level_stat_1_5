...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_crs_nord_anenii_noi;
import com.github.ivbaranov.mli.MaterialLetterIcon;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;
public class MyAdapter_crs_centru_anenii_noi extends RecyclerView.Adapter<MyAdapter_crs_centru_anenii_noi.ViewHolder>{
private Context c;
...
public class ViewHolder extends RecyclerView.ViewHolder implements
    ...
    private MyAdapter_crs_centru_anenii_noi.ItemClickListener itemClickListener;
    /**
    ...
    public void setItemClickListener(MyAdapter_crs_centru_anenii_noi.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_crs_centru_anenii_noi(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_crs_centru_anenii_noi.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_crs_centru_anenii_noi.ViewHolder vh = new MyAdapter_crs_centru_anenii_noi.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_crs_centru_anenii_noi.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_crs_nord_anenii_noi.class));
    }
