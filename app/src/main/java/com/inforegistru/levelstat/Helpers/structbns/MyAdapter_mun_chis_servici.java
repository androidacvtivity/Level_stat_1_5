...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_servicii;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_mun_chis_servici extends RecyclerView.Adapter<MyAdapter_mun_chis_servici.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_servici.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_servici.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_servici(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_servici.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_servici.ViewHolder vh = new MyAdapter_mun_chis_servici.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_servici.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_servicii.class));
    }
    @Override
