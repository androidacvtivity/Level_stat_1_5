...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_dir_macro;
import com.github.ivbaranov.mli.MaterialLetterIcon;




public class MyAdapter_dir_macro extends RecyclerView.Adapter<MyAdapter_dir_macro.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_dir_macro.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_dir_macro.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_dir_macro(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_dir_macro.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_dir_macro.ViewHolder vh = new MyAdapter_dir_macro.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_dir_macro.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dir_macro.class));
    }
    @Override
