...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_sec_cer_sondaj;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_sec_cer_sondaj extends RecyclerView.Adapter<MyAdapter_sec_cer_sondaj.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_sec_cer_sondaj.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_sec_cer_sondaj.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_sec_cer_sondaj(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_sec_cer_sondaj.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_sec_cer_sondaj.ViewHolder vh = new MyAdapter_sec_cer_sondaj.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_sec_cer_sondaj.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_sec_cer_sondaj.class));
    }
    @Override
