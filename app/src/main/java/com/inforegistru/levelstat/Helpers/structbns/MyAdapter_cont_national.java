...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_comt_national;
import com.github.ivbaranov.mli.MaterialLetterIcon;


public class MyAdapter_cont_national extends RecyclerView.Adapter<MyAdapter_cont_national.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_cont_national.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_cont_national.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_cont_national(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_cont_national.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_cont_national.ViewHolder vh = new MyAdapter_cont_national.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_cont_national.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_comt_national.class));
    }
    @Override
