...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_crs_nord;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_crs_nord extends RecyclerView.Adapter<MyAdapter_crs_nord.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_crs_nord.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_crs_nord.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_crs_nord(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_crs_nord.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_crs_nord.ViewHolder vh = new MyAdapter_crs_nord.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_crs_nord.ViewHolder holder, int position) {
