...
import com.inforegistru.levelstat.Views.structbns.DetailActivity_mun_chi_industrie;
import com.github.ivbaranov.mli.MaterialLetterIcon;

public class MyAdapter_mun_chis_industrie extends RecyclerView.Adapter<MyAdapter_mun_chis_industrie.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_industrie.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_industrie.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_industrie(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_industrie.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_industrie.ViewHolder vh = new MyAdapter_mun_chis_industrie.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_industrie.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_chi_industrie.class));
    }
    @Override
