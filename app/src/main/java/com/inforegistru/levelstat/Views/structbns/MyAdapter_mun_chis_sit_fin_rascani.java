...
public class MyAdapter_mun_chis_sit_fin_rascani extends RecyclerView.Adapter<MyAdapter_mun_chis_sit_fin_rascani.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_mun_chis_sit_fin_rascani.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_mun_chis_sit_fin_rascani.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_mun_chis_sit_fin_rascani(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_mun_chis_sit_fin_rascani.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_mun_chis_sit_fin_rascani.ViewHolder vh = new MyAdapter_mun_chis_sit_fin_rascani.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_mun_chis_sit_fin_rascani.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_mun_sit_fin_rascani.class));
    }
    @Override
