...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_centru_ungheni;
...
public class ScientistsActivity_crs_centru_ungheni  extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_centru_ungheni mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_centru_ungheni(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS CENTRU Ungheni";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_centru_ungheni.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
