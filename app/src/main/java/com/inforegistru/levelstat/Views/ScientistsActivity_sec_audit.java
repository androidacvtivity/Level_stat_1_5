...
import com.inforegistru.levelstat.Helpers.MyAdapter_sec_audit;
...
public class ScientistsActivity_sec_audit extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_audit mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_audit(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "sectia audit intern si managementul calitatii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_audit.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
