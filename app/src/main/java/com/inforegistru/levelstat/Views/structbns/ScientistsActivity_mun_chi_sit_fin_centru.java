...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_mun_chis_sit_fin_centru;
...
public class ScientistsActivity_mun_chi_sit_fin_centru extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_mun_chis_sit_fin_centru mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_mun_chis_sit_fin_centru(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "rapoarte statistice si situatii financiare sectorul Centru";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chi_sit_fin_centru.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
