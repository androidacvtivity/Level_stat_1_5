...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dg_colect_data;
...
public class ScientistsActivity_dg_colect_data  extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dg_colect_data mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dg_colect_data(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "colectarea datelor entitati economice";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dg_colect_data.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
