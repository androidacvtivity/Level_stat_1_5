...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_admin_sistem;
...
public class ScientistsActivity_dr_admin_sistem extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_admin_sistem mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_admin_sistem(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "administrare a sistemului informational";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_admin_sistem.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
