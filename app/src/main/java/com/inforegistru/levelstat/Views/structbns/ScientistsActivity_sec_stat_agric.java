...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_sec_stat_agric;
...
public class ScientistsActivity_sec_stat_agric extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_stat_agric mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_stat_agric(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "sectia statistica agriculturii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_stat_agric.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
