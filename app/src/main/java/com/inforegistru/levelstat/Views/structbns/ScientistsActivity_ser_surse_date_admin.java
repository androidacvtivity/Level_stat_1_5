...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_surse_date_admin;
...
public class ScientistsActivity_ser_surse_date_admin extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_surse_date_admin mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_surse_date_admin(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "surse de date administrative";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_ser_surse_date_admin.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
