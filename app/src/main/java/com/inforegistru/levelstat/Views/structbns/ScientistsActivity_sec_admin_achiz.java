...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_sec_admin_achiz;
...
public class ScientistsActivity_sec_admin_achiz extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_admin_achiz mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_admin_achiz(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "administrare si achizitii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_admin_achiz.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
