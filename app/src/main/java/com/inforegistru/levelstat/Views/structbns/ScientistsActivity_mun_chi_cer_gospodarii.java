...
public class ScientistsActivity_mun_chi_cer_gospodarii extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "cercetari gospodarii mun.Chisinau";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chi_cer_gospodarii.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
