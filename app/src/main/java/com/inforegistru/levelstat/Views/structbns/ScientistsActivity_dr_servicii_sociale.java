...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_serv_sociale;
...
public class ScientistsActivity_dr_servicii_sociale extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_serv_sociale mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_serv_sociale(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica serviciilor sociale";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_servicii_sociale.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
