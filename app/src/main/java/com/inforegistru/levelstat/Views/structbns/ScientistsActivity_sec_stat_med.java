...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_sec_stat_med;
...
public class ScientistsActivity_sec_stat_med extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_stat_med mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_stat_med(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "Serviciul statistica mediului";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_stat_med.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
