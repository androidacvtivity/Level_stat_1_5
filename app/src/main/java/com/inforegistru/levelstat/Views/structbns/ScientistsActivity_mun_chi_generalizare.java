...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_mun_chis_generalizare;
...
public class ScientistsActivity_mun_chi_generalizare extends  AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_mun_chis_generalizare mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_mun_chis_generalizare(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "generalizare date statistice cercetari economice";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chi_generalizare.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
