...
public class ScientistsActivity_mun_chi_sit_fin_rascani extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "rapoarte statistice si situatii financiare sectorul Rascani";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chi_sit_fin_rascani.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
