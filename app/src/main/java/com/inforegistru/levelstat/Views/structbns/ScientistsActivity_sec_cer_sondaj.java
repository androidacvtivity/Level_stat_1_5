...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_sec_cer_sondaj;
...
public class ScientistsActivity_sec_cer_sondaj extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_cer_sondaj mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_cer_sondaj(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "cercetari prin sondaj";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_cer_sondaj.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
