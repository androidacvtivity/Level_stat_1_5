...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_diseminare;
...
public class ScientistsActivity_dr_diseminare extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_diseminare mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_diseminare(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "diseminare si comunicare";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_diseminare.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
