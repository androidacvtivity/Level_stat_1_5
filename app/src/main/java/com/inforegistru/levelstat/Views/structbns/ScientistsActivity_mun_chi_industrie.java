...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_mun_chis_industrie;
...
public class ScientistsActivity_mun_chi_industrie extends  AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_mun_chis_industrie mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_mun_chis_industrie(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "industriei, investitiilor, constructiei si energeticii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chi_industrie.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
