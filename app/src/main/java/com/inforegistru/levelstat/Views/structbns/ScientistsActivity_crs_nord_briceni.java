...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_nord_briceni;
...
public class ScientistsActivity_crs_nord_briceni extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_nord_briceni mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_nord_briceni(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS NORD Briceni";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_nord_briceni.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
