...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_sud_taraclia;
...
public class ScientistsActivity_crs_sud_taraclia extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_sud_taraclia mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_sud_taraclia(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS SUD Taraclia";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_sud_taraclia.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
