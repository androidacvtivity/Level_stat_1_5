...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_nivel_trai;
...
public class ScientistsActivity_dr_nivel_trai extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_nivel_trai mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_nivel_trai(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica nivelului de trai";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_nivel_trai.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
