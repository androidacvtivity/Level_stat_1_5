...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_centru_anenii_noi;
...
public class ScientistsActivity_crs_nord_anenii_noi2  extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_centru_anenii_noi mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_centru_anenii_noi(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS CENTRU Anenii Noi";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_nord_anenii_noi2.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
