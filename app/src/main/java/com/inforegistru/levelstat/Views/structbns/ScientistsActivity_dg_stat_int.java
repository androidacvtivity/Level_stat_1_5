...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dg_stat_int;
...
public class ScientistsActivity_dg_stat_int extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dg_stat_int mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dg_stat_int(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica intreprinderilor";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dg_stat_int.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
