...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_centru_ialoveni;
...
public class ScientistsActivity_crs_centru_ialoveni  extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_centru_ialoveni mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_centru_ialoveni(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS CENTRU Ialoveni";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_centru_ialoveni.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
