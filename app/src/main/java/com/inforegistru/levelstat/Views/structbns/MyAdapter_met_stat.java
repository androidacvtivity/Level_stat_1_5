...
public class MyAdapter_met_stat extends RecyclerView.Adapter<MyAdapter_met_stat.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        private MyAdapter_met_stat.ItemClickListener itemClickListener;
        /**
        ...
        public void setItemClickListener(MyAdapter_met_stat.ItemClickListener itemClickListener) {
     ...
     */
    public MyAdapter_met_stat(Context mContext, ArrayList<Scientist> scientists) {
        this.c = mContext;
    ...
    @NonNull
    @Override
    public MyAdapter_met_stat.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.model_str, parent, false);
        view.setBackgroundResource(mBackground);
        MyAdapter_met_stat.ViewHolder vh = new MyAdapter_met_stat.ViewHolder(view);
        return vh;
    }
    /**
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_met_stat.ViewHolder holder, int position) {
        ...
        holder.setItemClickListener(pos -> Utils.sendScientistToActivity(c, s,
                DetailActivity_dr_met_stat.class));
    }
    @Override
