...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_centru_causeni;
...
public class ScientistsActivity_crs_centru_causeni extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

//We define our instance fields
private RecyclerView rv;
private MyAdapter_crs_centru_causeni mAdapter;
...
private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_centru_causeni(this, allPagesScientists);
...
final String start, String limit) {
        ...
        String director = "CRS CENTRU Causeni";
...
public void onFailure(Call<ResponseModel> call, Throwable t) {
        ...
        Utils.showInfoDialog(ScientistsActivity_crs_centru_causeni.this, "ERROR", t.getMessage());
        }
        });
        }
/**
