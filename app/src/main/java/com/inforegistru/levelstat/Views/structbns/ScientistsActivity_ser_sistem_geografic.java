...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_ser_sistem_informatic;
...
public class ScientistsActivity_ser_sistem_geografic extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_ser_sistem_informatic mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_ser_sistem_informatic(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "sisteme informationale geografice";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_ser_sistem_geografic.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
