...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_management_financiar;
...
public class ScientistsActivity_dr_management_financiar extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_management_financiar mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_management_financiar(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "management financiar";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_management_financiar.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
