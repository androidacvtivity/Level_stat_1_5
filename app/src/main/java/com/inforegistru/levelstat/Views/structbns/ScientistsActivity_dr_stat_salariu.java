...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_stat_salariu;
...
public class ScientistsActivity_dr_stat_salariu extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener {

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_stat_salariu mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_stat_salariu(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica salariilor";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_stat_salariu.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
