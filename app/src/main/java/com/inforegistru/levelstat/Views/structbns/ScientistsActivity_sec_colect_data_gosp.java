...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_sec_colect_data_gosp;
...
public class ScientistsActivity_sec_colect_data_gosp extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_sec_colect_data_gosp mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_sec_colect_data_gosp(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "colectarea datelor in gospodarii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_sec_colect_data_gosp.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
