...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_ser_man_doc;
...
public class ScientistsActivity_ser_man_doc extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{


    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_ser_man_doc mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_ser_man_doc(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "managementul documentelor";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_ser_man_doc.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
