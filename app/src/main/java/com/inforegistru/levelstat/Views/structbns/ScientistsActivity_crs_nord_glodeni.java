...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_nord_glodeni;
...
public class ScientistsActivity_crs_nord_glodeni extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_crs_nord_glodeni mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_crs_nord_glodeni(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS NORD Glodeni";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_nord_glodeni.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
