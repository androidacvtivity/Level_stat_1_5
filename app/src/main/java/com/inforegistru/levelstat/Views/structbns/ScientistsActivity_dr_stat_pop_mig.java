...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_stat_pop_mig;
...
public class ScientistsActivity_dr_stat_pop_mig extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_stat_pop_mig mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_stat_pop_mig(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica populatiei si migratiei";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_stat_pop_mig.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
