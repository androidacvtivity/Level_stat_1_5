...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_mun_chisinau_admin;
...
public class ScientistsActivity_mun_chisinau_admin extends  AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_mun_chisinau_admin mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_mun_chisinau_admin(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "mun.ChisinauAdministratia";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_mun_chisinau_admin.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
