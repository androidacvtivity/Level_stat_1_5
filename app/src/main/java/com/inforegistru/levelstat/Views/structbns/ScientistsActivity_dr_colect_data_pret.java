...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_colect_data_pret;
...
public class ScientistsActivity_dr_colect_data_pret extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_colect_data_pret mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_colect_data_pret(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "colectarea datelor preturi";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_colect_data_pret.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
