...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_stat_ocuparii;
...
public class ScientistsActivity_dr_stat_ocuparii extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_stat_ocuparii mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_stat_ocuparii(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "statistica ocuparii";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_stat_ocuparii.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
