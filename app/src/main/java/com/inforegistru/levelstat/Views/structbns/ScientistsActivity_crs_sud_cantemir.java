...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_crs_sud_cantemir;
...
public class ScientistsActivity_crs_sud_cantemir  extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "CRS SUD Cantemir";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_crs_sud_cantemir.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
