...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_poligrafica;
...
public class ScientistsActivity_dr_poligrafica extends AppCompatActivity
        implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_poligrafica mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_poligrafica(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "deservire poligrafica";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_poligrafica.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
