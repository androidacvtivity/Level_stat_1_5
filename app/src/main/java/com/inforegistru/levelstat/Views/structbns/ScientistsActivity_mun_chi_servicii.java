...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_mun_chis_servici;
...
public class ScientistsActivity_mun_chi_servicii extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
//We define our instance fields
private RecyclerView rv;
private MyAdapter_mun_chis_servici mAdapter;
...
private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_mun_chis_servici(this, allPagesScientists);
...
final String start, String limit) {
        ...
        String director = "statistica serviciilor de piata";
...
public void onFailure(Call<ResponseModel> call, Throwable t) {
        ...
        Utils.showInfoDialog(ScientistsActivity_mun_chi_servicii.this, "ERROR", t.getMessage());
        }
        });
        }
/**
