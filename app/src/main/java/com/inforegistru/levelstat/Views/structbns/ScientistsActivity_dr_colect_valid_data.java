...
import com.inforegistru.levelstat.Helpers.structbns.MyAdapter_dr_colect_valid_data;
...
public class ScientistsActivity_dr_colect_valid_data extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{


    //We define our instance fields
    private RecyclerView rv;
    private MyAdapter_dr_colect_valid_data mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapter_dr_colect_valid_data(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        String director = "colectarea si validarea datelor";
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(ScientistsActivity_dr_colect_valid_data.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
